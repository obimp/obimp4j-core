...
public class XStatus {
    ...
    "нет статуса","улыбаюсь","на пляже","коктейль","спасатель","чистка","пица","праздник","думаю",
    "обедаю","смотрю тв","друзья","пью кофе","слушаю музыку","бизнес","смотрю фильм","показываю язык","на телефоне",
    "играю","на учебе","в магазине","катаюсь на машине","болею","сплю","в интернете","работаю","печатаю",
    "на пикинике","занимаюсь спортом","на телефоне","плачу","в туалете","вопрос","слушаю музыку","сердце","на охоте",
    "в поиске","блокнот","звезда","краски","в душе","ёлка","лампочка","деньги","записная книжка",
    "химия","солнце","снег","инструмент","палец вверх","в шоке","планета","пиво","злой",
    "засыпаю","курю"};
