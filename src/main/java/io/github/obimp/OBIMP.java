...
//                System.out.println("set_upd_info: userId="+userId);
                ...
                if(info.getGender() != -1){
                upd_inf.append(new wTLD(0x0000000C, new io.github.obimp.data.type.Byte( ((info.getGender() != 0x01) && (info.getGender() != 0x02)) ? 0x00 : info.getGender() ))); //пол
                }
...
//                System.out.println("cliSearch: userId="+userId);
                ...
                switch(typeSearch){
                    ...
                    case 5: //wTLD 0x0009: Byte, gender (0x00 - not specified, 0x01 - female, 0x02 - male)
                        search.append(new wTLD(0x00000009, new io.github.obimp.data.type.Byte( Byte.parseByte(String.valueOf(obj)) )));
                        break;
                    ...
                    case 8: //wTLD 0x000C: Byte, zodiac sign code (see below)
                        search.append(new wTLD(0x0000000C, new io.github.obimp.data.type.Byte( Byte.parseByte(String.valueOf(obj)) )));
                        //ZODIAC_ARIES = 0x01
                        //ZODIAC_TAURUS = 0x02
                        //ZODIAC_GEMINI = 0x03
                        //ZODIAC_CANCER = 0x04
                        ...
                        break;   
                    case 9:
                        search.append(new wTLD(0x0000000A, new io.github.obimp.data.type.Byte( Byte.parseByte(String.valueOf(obj).split("-")[0]) ))); //wTLD 0x000A: Byte, age min (this value is starting from 1)
                        search.append(new wTLD(0x0000000B, new io.github.obimp.data.type.Byte( Byte.parseByte(String.valueOf(obj).split("-")[1]) ))); //wTLD 0x000B: Byte, age max
                        break;
